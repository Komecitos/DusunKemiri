...
<div class="max-w-7xl mx-auto px-4 py-8 mr-4 ml-4 md:mr-20 md:ml-20 mb-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-2">
            <button
                onclick="window.location.href='{{route('berita.index')}}'"
                class="bg-sogan text-white px-4 py-2 rounded-md hover:bg-opacity-80 transition mb-4" width="20px" height="auto">
                Kembali
            </button>
